...
// we get props in arguments and destrtcture here otherwise we can directly use also without destructuring it

// * tailwing installation ke liye directly we take reference from tailwind official website

function Card ({username,review = 4}) {
    return (
        ...
        <div class="mx-auto flex flex-wrap items-center lg:w-4/5">
            ...
            <h2 class="text-sm font-semibold tracking-widest text-red-500">
                Nike
            </h2>
            <h1 class="my-4 text-3xl font-semibold text-orange-400">
                {username[1] || username.name} Air Max 21A
            </h1>
            {/* here we can get access of the username array and object also */}
            ...
            <div class="flex items-center justify-between">
                <span class="title-font text-xl font-bold text-blue-900">
                ₹47,199
                </span>
                <button
                type="button"
